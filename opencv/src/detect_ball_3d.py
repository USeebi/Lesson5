...
class DetectBall3d(rclpy.node.Node):
    ...
    def __init__(self):
        ...
        self.ball2d_sub  = self.create_subscription(Point,"/blob/point_blob",self.ball_rcv_callback, 10)
        self.ball3d_pub  = self.create_publisher(PoseStamped,"/blob/detected_ball_3d",1)
        self.ball_marker_pub  = self.create_publisher(Marker,"/blob/ball_3d_marker",1)
    ...
    def ball_rcv_callback(self,data : Point):
        ...
        self.get_logger().info('Sending target pose: "%s"' % p)
...
# https://hotblackrobotics.github.io/en/blog/2018/01/29/action-client-py/
        ...
        #rospy.loginfo("Sending target pose: " + str(p))
